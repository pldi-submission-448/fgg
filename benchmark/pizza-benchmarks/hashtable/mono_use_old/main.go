...
type _mapᐸᐳ struct {};
type HashtableᐸIntᐸᐳᐨStringᐸᐳᐳ struct { _inner map[interface{}]interface{} };
func (this *HashtableᐸIntᐸᐳᐨStringᐸᐳᐳ) getᐸᐳ(key Intᐸᐳ) Stringᐸᐳ { return this._inner[key].(Stringᐸᐳ)
};
...
func (this Dummyᐸᐳ) Mainᐸᐳ() Dummyᐸᐳ {
	ht := HashtableᐸIntᐸᐳᐨStringᐸᐳᐳ{make(map[interface{}]interface{})}
	for i := 0; i < 1000; i++ {
