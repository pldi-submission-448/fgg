...
type Cellǂ struct { elemǂ Any; dict_0 AnyǂDictǂ };
type Cellǂ_meta struct { _type_0 _type_metadata };
func (this Cellǂ_meta) tryCast(x Any) Any { _ = x.(Cellǂ);
	this._type_0.assertEq(x.(Cellǂ).dict_0._type);
	return x;
};
func (this Cellǂ_meta) assertEq(x _type_metadata) Any { this._type_0.assertEq(x.(Cellǂ_meta)._type_0);
	return this;
};
func (thisǂ *Cellǂ) addǂ(elemǂ Any) Any { return Cellǂ{elemǂ, thisǂ.dict_0};
};
func (thisǂ Cellǂ) spec_add() spec_metadata_1 { return spec_metadata_1{thisǂ.dict_0._type, Cellǂ_meta{thisǂ.dict_0._type}};
};
func (thisǂ *Cellǂ) getǂ() Any { return thisǂ.elemǂ;
};
func (thisǂ Cellǂ) spec_get() spec_metadata_0 { return spec_metadata_0{thisǂ.dict_0._type};
};
type Dummyǂ struct {};
...
func (thisǂ Dummyǂ) CellTestǂ(dict_0 AnyǂDictǂ, elemǂ Any) Any {
	cǂ := Cellǂ{42, dict_0};
	cǂ.addǂ(42)
...
func main() {
	fmt.Println(1)
	_ = Dummyǂ{}.CellTestǂ(AnyǂDictǂ{Int1ǂ_meta{}}, 42)
	fmt.Println(2)
}
