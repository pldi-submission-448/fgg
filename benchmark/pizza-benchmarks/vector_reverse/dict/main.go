...
func (this Vectorǂ_meta) tryCast(x Any) Any { _ = x.(Vectorǂ);
	this._type_0.assertEq(x.(Vectorǂ).dict_0._type);
	return x;
};
...
func (vǂ Vectorǂ) spec_get() spec_metadata_1 { return spec_metadata_1{intǂ_meta{}, vǂ.dict_0._type};
};
func (vǂ *Vectorǂ) setǂ(iǂ Any, xǂ Any) Any {
	vǂ.elementDataǂ[iǂ.(int)] = xǂ;
	return Dummyǂ{};
};
func (vǂ Vectorǂ) spec_set() spec_metadata_2 { return spec_metadata_2{intǂ_meta{}, vǂ.dict_0._type, Dummyǂ_meta{}};
};
...
func BenchmarkVectorReverse_string() {
	...
	v := Vectorǂ{
		elementDataǂ:  make([]Any, iterations),
		elementCountǂ: iterations,
		dict_0: AnyǂDictǂ{string_ǂ_meta{}},
	}
	for i := 0; i < iterations; i++ {
