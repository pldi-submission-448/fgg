...
func (this ResizableArrayǂ_meta) tryCast(x Any) Any { _ = x.(ResizableArrayǂ);
	this._type_0.assertEq(x.(ResizableArrayǂ).dict_0._type);
	return x;
};
...
func (raǂ ResizableArrayǂ) spec_add() spec_metadata_1 { return spec_metadata_1{raǂ.dict_0._type, Dummyǂ_meta{}};
};
...
func (raǂ ResizableArrayǂ) spec_contains() spec_metadata_1 { return spec_metadata_1{raǂ.dict_0._type, boolǂ_meta{}};
};
...
func main() {
	_ = Dummyǂ{}.Mainǂ(AnyǂDictǂ{intǂ_meta{}}, intǂ(4)).
		(Dummyǂ).Mainǂ(AnyǂDictǂ{longǂ_meta{}}, 4).
		(Dummyǂ).Mainǂ(AnyǂDictǂ{doubleǂ_meta{}}, 4)
}
